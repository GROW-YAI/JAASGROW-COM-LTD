...
const Footer = () => {
  return (
    <footer className="bg-[#186306] text-white h-[20%]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              ...
              ducimus perspiciatis culpa possimus numquam doloribus deserunt
              maxime ut laudantium, inventore enim ea animi nostrum, corporis
              alias. Velit rerum a esse.
            </p>
          </div>
