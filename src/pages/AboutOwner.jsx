...
//         <div>
//         <img src={owner} alt="" className="w-52 h-52 md:w-52 md:h-52 rounded-full bg-gray-300 flex items-center justify-center text-gray-500 text-lg font-semibold" />
//         </div>

//         {/* Owner Bio */}
//         <div className="flex-1">
//           <h3 className="text-2xl font-semibold text-green-800">Justice Kwadwo Turzin</h3>
