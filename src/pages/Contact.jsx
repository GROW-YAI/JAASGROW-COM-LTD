  ...
  return (
    ...
    {/* <img src={con}alt="" srcset=""  className='w-full h-72 object-fit border rounded-lg shadow-lg'/> */}
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 flex gap-2 items-center"><FaAddressBook className='text-blue-600 text-lg' />Cape Coast, Cape Coast, Ghana</p>
        <p className="text-gray-600 flex gap-2 items-center"><FaMailBulk className='text-blue-900 text-lg'/> jaagrow@yahoo.com</p>
